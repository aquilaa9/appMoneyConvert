...
public final class ActivitySplashBinding implements ViewBinding {
  ...
  private ActivitySplashBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView appTitleTextView, @NonNull TextView authorNameTextView) {
  ...
  public static ActivitySplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.authorNameTextView;
      TextView authorNameTextView = ViewBindings.findChildViewById(rootView, id);
      if (authorNameTextView == null) {
        break missingId;
      }

      return new ActivitySplashBinding((ConstraintLayout) rootView, appTitleTextView,
          authorNameTextView);
    }
